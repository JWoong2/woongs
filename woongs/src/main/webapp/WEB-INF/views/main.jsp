									...
									$("#" + args[i].category_first)
											.after(
													"<div class='post' id='"+args[i].no+"'><a href='cart?post_no="
															...
															+ args[i].no
															+ "' class='wish off' onclick='changeHeart($(this).attr("+ '"'+ 'id'+ '"'+ "),$(this).attr("+ '"'+ 'class'+ '"'+ "));'><img src='/resources/Images/emptyheart.png'></a></div>");
...
//포문돌리기
		...
		function changeHeart(id, className) {
			console.log(id.replace("heart","")*1);
			console.log(id.replace("heart",""));
