...
public class CouponController {
	...
	public String issueCoupon(CouponDto dto, HttpSession session  ) {
		// 나중에 session 값으로 admin_id 를 가져옴
		dto.setAdmin_id((String)session.getAttribute("user_id"));
		System.out.println("dto.getAdmin_id()::"+dto.getAdmin_id());
