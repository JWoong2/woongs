 ...
 * Generated at: 2020-08-26 00:46:30 UTC
...
public final class chatRoom_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t$.ajax({\n");
      out.write("\t\t\ttype : \"post\",\n");
      out.write("\t\t\turl : \"chatClientRoom\",\n");
      out.write("\t\t\tdataType : \"json\"\n");
      out.write("\t\t}).done(\n");
      out.write("\t\t\t\tfunction(args) { //응답이 성공 상태 코드를 반환하면 호출되는 함수\n");
      out.write("\t\t\t\t\tif (args.length == 0) {\n");
      out.write("\t\t\t\t\t\t$(\"#client\").append(\"<div> 채팅이 없습니다. </div>\");\n");
      out.write("\n");
      out.write("\t\t\t\t\t} else {\n");
      out.write("\t\t\t\t\t\tfor (var i = 0; i < args.length; i++) {\n");
      out.write("\t\t\t\t\t\t\t$(\"#client\").append(\n");
      out.write("\t\t\t\t\t\t\t\t\t\"<div>\"+ args[i].worker_name + \" \"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ \"<img src='\"+args[i].worker_image +\"'/>\" + \" \"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ args[i].title + \" \" \n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ args[i].message_content + \" \"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ args[i].unReadCount + \" \"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ args[i].message_sendTime + \" \"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+ \"<a href='chatAsk?no=\"+args[i].post_no+\"&&user_id=\"+ args[i].worker_id +\"'>채팅</a>\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t+\"</div>\");\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t}\n");
      ...
      out.write("\t\t$.ajax({\n");
      out.write("\t\t\ttype : \"post\",\n");
      out.write("\t\t\turl : \"chatWorkerRoom\",\n");
      out.write("\t\t\tdataType : \"json\"\n");
      out.write("\t\t}).done(\n");
      out.write("\t\t\t\tfunction(args) { //응답이 성공 상태 코드를 반환하면 호출되는 함수\n");
      out.write("\t\t\t\t\tif (args.length == 0) {\n");
      out.write("\t\t\t\t\t\t$(\"#worker\").append(\"<div> 채팅이 없습니다. </div>\");\n");
      out.write("\t\t\t\t\t} else {\n");
      out.write("\t\t\t\t\t\tfor (var i = 0; i < args.length; i++) {\n");
      out.write("\t\t\t\t\t\t\t$(\"#worker\").append(\n");
      out.write("\t\t\t\t\t\t\t\t\t\"<div>\"+ args[i].client_name + \" \"\n");
      out.write("\t\t\t\t\t\t\t\t\t+ \"<img src='\"+args[i].client_image +\"'/>\" + \" \"\n");
      out.write("\t\t\t\t\t\t\t\t\t+ args[i].title + \" \" \n");
      out.write("\t\t\t\t\t\t\t\t\t+ args[i].message_content + \" \"\n");
      out.write("\t\t\t\t\t\t\t\t\t+ args[i].unReadCount + \" \"\n");
      out.write("\t\t\t\t\t\t\t\t\t+ args[i].message_sendTime + \" \"\n");
      out.write("\t\t\t\t\t\t\t\t\t+ \"<a href='chatAnswer?no=\"+args[i].post_no+\"&&user_id=\"+ args[i].client_id +\"'>채팅</a>\"\n");
      out.write("\t\t\t\t\t\t\t\t\t+\"</div>\");\n");
      out.write("\t\t\t\t\t\t}\n");
      out.write("\t\t\t\t\t}\n");
      out.write("\t\t\t\t}).fail(function(e) {\n");
      ...
      out.write("</script>\n");
      out.write("\n");
      out.write("<div id=\"client\">의뢰인</div>\n");
      out.write("<div id=\"worker\">작업자</div>\n");
      out.write("\n");
      out.write("</body>\n");
      out.write("</html>");
